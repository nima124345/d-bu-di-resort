            ...
            if (this.status == 200) {
                ...
                for (const i in data) {
                    ...
                    reuslt += `<tr>
                                                ...
                                                <td><span class="right badge badge-success">${item.status}</span></td>
                                                <td> 
                                                    <button onclick="onClickDetail(${item.id})" type="button" class="btn btn-block btn-info">ดูรายละเอียด</button>
                                                    <button onclick="onClickDetail(${item.id})" type="button" class="btn btn-block btn-danger">ลบ</button>
                                                </td>
